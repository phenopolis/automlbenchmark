...
Rscript -e 'options(install.packages.check.source="no"); install.packages(c("xgboost", "farff", "ranger", "LiblineaR", "emoa", "e1071", "glmnet"), repos="https://cloud.r-project.org/", lib="'"${LIB}"'")'
